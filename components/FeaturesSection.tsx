...
const FEATURES: Feature[] = [
  { icon: Compass, title: "Guide", body: "Sees the path forward when a decision feels too big to hold alone." },
  { icon: MessageCircle, title: "Mentor", body: "Grows your thinking, one honest conversation at a time." },
  { icon: CalendarCheck, title: "Planner", body: "Turns scattered intentions into a plan you'll actually follow." },
  { icon: HeartHandshake, title: "Companion", body: "Present for the everyday moments, remembering what matters." },
];
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map(({ icon: Icon, title, body }) => (
              ...
              >
                ...
                <h3 className="mb-3 font-playfair text-xl font-light text-white/92">{title}</h3>
                <p className="text-sm leading-relaxed text-white/55 font-light">{body}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
