...
export const storyChapters: StoryChapterData[] = [
  ...
  {
    index: 9,
    imageSrc: "/story/chapter-9.jpeg",
    eyebrow: "09 / A Mind Made of Light",
    headline: "Then we built something that could think alongside us.",
    body: "The computer didn't replace the mind — it gave it somewhere new to grow.",
    kenBurns: "pan-left",
    grade: 0.96,
  },
  {
    index: 10,
    imageSrc: "/story/chapter-10.jpeg",
    eyebrow: "10 / The Next Step",
    headline: "And still, we looked up — and asked what else was possible.",
    body: "Every leap forward began the same way: someone believed the next step was worth taking. This one is ours.",
    kenBurns: "zoom-out",
    grade: 1,
    isLast: true,
  },
